...
function TextBlinkLoader({
  ...
  return (
    <div
      className={cn(
        "animate-[text-blink_2s_ease-in-out_infinite] font-mono font-normal",
        textSizes[size],
        className
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "bg-[length:200%_auto] bg-clip-text font-mono font-normal text-transparent",
...
function TextDotsLoader({
  ...
  return (
    <div className={cn("inline-flex items-center", className)}>
      <span className={cn("text-primary font-mono font-normal", textSizes[size])}>
        {text}
      </span>
